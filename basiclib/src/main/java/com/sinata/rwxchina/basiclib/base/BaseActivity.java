...
public abstract class BaseActivity extends RxAppCompatActivity implements View.OnClickListener{
     ...
     * @param clz
     */
    public void startActivityRuntime(String clz) {
        try {
            Class c = Class.forName(clz);
            startActivity(new Intent(BaseActivity.this,c).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } catch (ClassNotFoundException e) {
            LogUtils.e("跳转异常",e.toString());
            e.printStackTrace();
        }
     ...
     * @param bundle
     */
    public void startActivityRuntime(String clz, Bundle bundle) {
        Intent intent = new Intent();
        try {
            Class c = Class.forName(clz);
