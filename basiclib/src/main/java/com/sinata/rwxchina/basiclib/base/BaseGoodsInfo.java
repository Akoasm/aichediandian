package com.sinata.rwxchina.basiclib.base;
...
public class BaseGoodsInfo {
     ...
     * goods_score : 0
     * goods_type_labels : ["七天包退","品质保障","优质服务"]
     * goods_unit : 套
     ...
     * goods_is_freight : 1
     * goods_freight : 0.00
     * goods_type_labels_str : 七天包退,品质保障,优质服务
     */
    ...
    private List<CashCouponGroupEntity> goods_group_data;
    ...
    public List<CashCouponGroupEntity> getGoods_group_data() {
        return goods_group_data;
    }

    public void setGoods_group_data(List<CashCouponGroupEntity> goods_group_data) {
