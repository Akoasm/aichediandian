...
//                context.startActivity(intent);
                ...
                i.putStringArrayListExtra("list_img", (ArrayList<String>) imglist);
                i.putExtra("image_position", (currentPosition % imglist.size())+1);
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(context)
                    ...
                    .apply(new RequestOptions()
                            .fallback(R.mipmap.background)//请求图片的url为空
                            .placeholder(R.mipmap.background)//请求图片加载中
                            .diskCacheStrategy(DiskCacheStrategy.RESOURCE)
                            .error(R.mipmap.image_fail_c))
                    .thumbnail(0.1f)
                    .into(imageView);
