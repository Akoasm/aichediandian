...
public class HealthAdapter extends BaseAdapter {
    private Context mC;
    private List<NearHealthEntity.BodyBean> list;

    public HealthAdapter(Context mC) {
        this.mC = mC;
        this.list = new ArrayList<>();
    }

    public List<NearHealthEntity.BodyBean> getList() {
        return list;
    }

    public void setList(List<NearHealthEntity.BodyBean> list) {
        this.list = list;
    }
