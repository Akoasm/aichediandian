...
public class ApiUtils{
    //使用软引用对象
    private SoftReference<OnNextCallBack> onNextCallBack;
    private SoftReference<RxAppCompatActivity> appCompatActivity;
    private Dialog dialog;
    private OkHttpClient.Builder builder;
    public ApiUtils(RxAppCompatActivity appCompatActivity,OnNextCallBack onNextCallBack) {
        this.onNextCallBack = new SoftReference<OnNextCallBack>(onNextCallBack);
    ...
    public void httpDeal(Observable observable, BaseApi api){
        ...
        //回调结果（弹出加载框）
        if (onNextCallBack!=null&&onNextCallBack.get()!=null){
