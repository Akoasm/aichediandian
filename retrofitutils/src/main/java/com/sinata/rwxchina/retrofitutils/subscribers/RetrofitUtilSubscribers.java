...
public class RetrofitUtilSubscribers<T> extends Subscriber<T> {
    ...
    private BaseApi api;
    public RetrofitUtilSubscribers(Dialog dl,BaseApi api,SoftReference<Context> mActivity,SoftReference<OnNextCallBack> onNextCallBack){
        this.pd=dl;
        this.api=api;
        this.mActivity = mActivity;
        this.onNextCallBack=onNextCallBack.get();
...
//        dismissProgress();
        if (onNextCallBack!=null){
            try {
                onNextCallBack.onNext((String) t, api.getMethod());
            } catch (Exception e) {
